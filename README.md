PHP Native Template with KaiAdmin
...
📦 Cara Penggunaan
Jalankan perintah berikut di terminal: php -S localhost:8000 -t public

Buka browser dan akses: http://localhost:8000

Catatan: Port dapat disesuaikan sesuai kebutuhan, tidak harus 8000.